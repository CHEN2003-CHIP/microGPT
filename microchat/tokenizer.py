...
# 文本分割正则表达式（GPT-4风格，数字部分调整为匹配1-2位）
# 调整原因：避免小词汇量时过多令牌消耗在数字上
...
class HuggingFaceTokenizer:
    ...
    def train_from_iterator(cls, text_iterator, vocab_size):
        ...
        # Normalizer: None
        #NOTE:why do we need normalizer?
    ...
    def _encode_one(self, text, prepend=None, append=None, num_threads=None):
        ...
        # num_threads is ignored (only used by the microchat tokenizer for parallel encoding)
...
class RustBPETokenizer:
    ...
    def from_pretrained(cls, tiktoken_name):
        ...
        # so in microGPT we always use "<|bos|>" short for "beginning of sequence", but historically it is often called "<|endoftext|>".
...
# -----------------------------------------------------------------------------
# microchat-specific convenience functions
